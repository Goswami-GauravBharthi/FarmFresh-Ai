...
const Marketplace = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      unit: "lb",
      image:
        "https://plus.unsplash.com/premium_photo-1664527307650-7de397f25c79?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      created_at: "2025-08-03",
    },
    {
      id: 3,
      ...
      unit: "dozen",
      image:
        "https://images.unsplash.com/photo-1598965675045-45c5e72c7d05?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      created_at: "2025-08-02",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      unit: "lb",
      image:
        "https://images.unsplash.com/photo-1567375698463-b8dabb1319cf?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      created_at: "2025-08-05",
    },
    {
      id: 6,
      ...
      description:
        "Fresh, organic broccoli with deep green color and tight florets.",
      price_per_unit: 2.99,
      quantity: 60,
      unit: "lb",
      image:
    ...
    },
    {
      ...
      farmer_id: "F006",
      name: "Raw Honey",
      description: "Golden, unfiltered honey straight from the farm beehives.",
      price_per_unit: 9.99,
      quantity: 20,
      unit: "liter",
      image:
    ...
    },
    {
      ...
      farmer_id: "F003",
      name: "Fresh Milk",
      description: "Creamy farm-fresh milk from grass-fed cows.",
      price_per_unit: 3.49,
      quantity: 80,
      unit: "liter",
      image:
        "https://plus.unsplash.com/premium_photo-1695042864778-6d67ec3953e9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      ...
      farmer_id: "F004",
      name: "Sweet Corn",
      description: "Golden, juicy corn perfect for grilling or boiling.",
      price_per_unit: 1.99,
      quantity: 90,
      unit: "lb",
      image:
        "https://images.unsplash.com/photo-1683543124257-1d214be3a366?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      created_at: "2025-08-07",
    },
    {
      id: 10,
      ...
      name: "Leafy Spinach",
      description:
        "Nutrient-rich spinach, freshly harvested and organically grown.",
      price_per_unit: 2.29,
      quantity: 70,
      unit: "bunch",
      image:
